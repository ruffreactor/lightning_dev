...
return(
    ...
    <g>
        ...
        {/*TO-DO: RayNetwork Live Morpher: This component should keep morphing the ray network and randomizing the rayNodePouints while keeping the same mouse source and dest pos to simulate ALIVE lightning*/}

        {/*TO-DO: Mousewheel energy ball charging. user must be able to lock the cursor and spin their mousewheel to charge an energy ball of electricty. The user should be encouraged to almost damage their mousewheel by making the ball grow bigger based on the speed of rotation. */}
